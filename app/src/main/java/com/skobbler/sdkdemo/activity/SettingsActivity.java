    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                String prefValue = listPreference.getEntry().toString();
                if(prefValue.equals("Bicycle fastest") || prefValue.equals("Bicycle shortest") || prefValue.equals("Bicycle quietest")){

                    final AlertDialog alertDialog = new AlertDialog.Builder(SettingsActivity.this).create();
                    alertDialog.setMessage(getString(R.string.bicycle_license_notification_text));
